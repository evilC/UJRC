...
elite.AddShift({type: "UJRC_Shift", stick: 1, pov: 0,  button: "5", shiftmode: "power"})
;elite.Add({type: "UJRC_Button", stick: 1, pov: 1, shiftmode: "default", key_array: ["w","d","s","a"], allow_diagonals: 1})
